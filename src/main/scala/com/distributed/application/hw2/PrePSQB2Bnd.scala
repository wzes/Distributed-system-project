...
object PrePSQB2Bnd {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val train = ss.sparkContext.textFile("data/seq_trade_" + dataset + "train_bndno_b.txt")

    val test = ss.sparkContext.textFile("data/seq_trade_" + dataset + "test_bndno_b.txt")
  ...
  def predict(arrays: Array[String], trainLines: Array[String],
    ...
    // output table
    val writer = new BufferedWriter(new FileWriter("data/seq_pre_" + dataset + "rate_bnd.csv"))
